...
{
	/**
	 * Stateless twin of {@link #loginVisitor(Mutiny.StatelessSession, ProfileServiceDTO, ISystems, java.util.UUID...)}.
	 * <p>
	 ...
	 */
	Uni<Void> setUserLoggedIn(Mutiny.StatelessSession session, IInvolvedParty<?, ?> newIp,
	 ...
	 */
	Uni<Void> setUserLoggedOut(Mutiny.StatelessSession session, IInvolvedParty<?, ?> involvedParty,
	 ...
	 */
	Uni<UserConfirmationKeyDTO<?>> registerVisitor(Mutiny.StatelessSession session, UserRegistrationDTO<?> userRegistrationDTO, ISystems<?, ?> system, java.util.UUID... identityToken);
	 ...
	 */
	Uni<ProfileServiceDTO<?>> loginUser(Mutiny.StatelessSession session, UserLoginDTO<?> profileServiceDTO, ISystems<?, ?> system, java.util.UUID... identityToken);
	 ...
	 * Note: ProfileServiceException is handled within the reactive chain
	 */
	Uni<ProfileServiceDTO<?>> logoutUser(Mutiny.StatelessSession session, ProfileServiceDTO<?> profileServiceDTO, ISystems<?, ?> system, java.util.UUID... identityToken);
	 ...
	 * Note: ProfileServiceException is handled within the reactive chain
	 */
	Uni<ProfileServiceDTO<?>> loginUser(Mutiny.StatelessSession session, UserLoginDTO<?> profileServiceDTO, boolean alreadyVerified, ISystems<?, ?> system, java.util.UUID... identityToken);
	 ...
	 */
	Uni<Boolean> verifyUsernameExists(Mutiny.StatelessSession session, UserLoginDTO<?> userLoginDTO, ISystems<?, ?> system, java.util.UUID... identityToken);
	 ...
	 */
	Uni<UserLoginDTO<?>> verifyPasswordForUser(Mutiny.StatelessSession session, UserLoginDTO<?> userLoginDTO, IEnterprise<?, ?> enterprise, ISystems<?,?>system, java.util.UUID... identityToken);
}